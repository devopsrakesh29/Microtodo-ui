...
const GET_TASKS_API_BASE_URL = "http://gettask.devopsinsight.biz/api";
const DELETE_TASK_API_BASE_URL = "http://deletetask.devopsinsight.biz/api";
const CREATE_TASK_API_BASE_URL = "http://addtask.devopsinsight.biz/api";
