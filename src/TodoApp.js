...
const GET_TASKS_API_BASE_URL = "http://gettask.devopsinsight.biz";
const DELETE_TASK_API_BASE_URL = "http://deletetask.devopsinsight.biz";
const CREATE_TASK_API_BASE_URL = "http://addtask.devopsinsight.biz";
